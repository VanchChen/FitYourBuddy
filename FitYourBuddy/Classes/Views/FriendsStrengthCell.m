...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _cellIndexLabel = [CommonUtil createLabelWithText:@"9999" andTextColor:themePureBlueColor];
        ...
        _cellNameLabel = [CommonUtil createLabelWithText:@"大胖砸" andFont:[UIFont systemFontOfSize:15.0f]];
        [_grayBackgroundView addSubview:_cellNameLabel];
        
        _cellScoreLabel = [CommonUtil createLabelWithText:@"1000瓦" andTextColor:[UIColor blackColor] andFont:[UIFont systemFontOfSize:15.0f] andTextAlignment:NSTextAlignmentRight];
...
@implementation FriendsMyStrengthCell
